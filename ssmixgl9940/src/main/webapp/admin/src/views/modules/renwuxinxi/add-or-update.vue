<template>
	<div class="addEdit-block">
		...
		>
			...
			<el-form-item v-else-if="ruleForm.renwuyaoqiu" label="任务要求" prop="renwuyaoqiu" >
				<span class="text">{{ruleForm.renwuyaoqiu}}</span>
			</el-form-item>
			<el-form-item class="textarea" v-if="type!='info'" label="任务奖励" prop="renwujiangli" >
				<el-input
					style="min-width: 200px; max-width: 600px;"
					type="textarea"
					:rows="8"
					placeholder="任务奖励"
					v-model="ruleForm.renwujiangli" >
				</el-input>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.renwujiangli" label="任务奖励" prop="renwujiangli" >
				<span class="text">{{ruleForm.renwujiangli}}</span>
			</el-form-item>
		...
		data() {
			return {
				...
				rules: {
					...
					renwujiangli: [
						{ required: true, message: '任务奖励不能为空', trigger: 'blur' },
					],
					reversetime: [
					],
				},
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='renwujiangli'){
							this.ruleForm.renwujiangli = obj[o];
							this.ro.renwujiangli = true;
							continue;
						}
						if(o=='reversetime'){
